...
if __name__ == '__main__':
        ...
        print(' 1) Divide the unsorted list to sublists, ')
        print('     each containing 1 element.')
        print(' 2) Merge sublists to produce new sorted sublists ')
        ...
        print('2) unsorted list 10 items: {} ms.'.format(times[1]))
        print('3) unsorted list 100 items: {} ms.'.format(times[2]))
        print('4) unsorted list 1000 items: {} ms.'.format(times[3]))
        print('5) sorted list 1000 items: {} ms.'.format(times[4]))
